...
const StatsDashboardDemo = () => {
  ...
  const setDemoStats = () => {
    // Demo stats that look impressive for the pitch
    setStats({
      totalUsers: 247,
      verifiedUsers: 238,
      totalListings: 156,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-end mb-4">
          <button
            ...
            className="px-4 py-2 bg-white rounded-lg shadow-md text-sm font-medium text-gray-700 hover:bg-gray-50 transition"
          >
            {useRealData ? '📊 Real Data' : '🎭 Demo Mode'} (Click to toggle)
          </button>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          {!useRealData && (
            <div className="mt-2 text-sm text-gray-500">
              (Demo mode - showing projected numbers)
            </div>
          )}
        </div>
...
export default StatsDashboardDemo;
