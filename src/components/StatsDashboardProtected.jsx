...
const StatsDashboardProtected = () => {
  ...
  // ✅ ADMIN EMAILS - Only these can access the dashboard
  const ADMIN_EMAILS = [
    'your-email@login.cuny.edu',  // ⬅️ CHANGE THIS to your actual email
    'admin@login.cuny.edu'
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="inline-flex items-center px-4 py-2 bg-red-100 text-red-800 rounded-full">
            ...
            <span className="font-semibold">Admin Only Dashboard</span>
          </div>
...
export default StatsDashboardProtected;
